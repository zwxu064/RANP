...
class DoubleConv(nn.Sequential):
    ...
    def __init__(self, in_channels, out_channels, encoder, kernel_size=3, order='crg', num_groups=8, width=2,
                 res_type=None):
...
class ExtResNetBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, order='cge', num_groups=8, res_type=None, **kwargs):
