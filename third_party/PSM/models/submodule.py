...
def convbn_3d(in_planes, out_planes, kernel_size, stride, pad, enable_bn=True):
    if enable_bn:
...
class BasicBlock(nn.Module):
    expansion = 1
    def __init__(self, inplanes, planes, stride, downsample, pad, dilation, activation_mode):
...
class feature_extraction(nn.Module):
    def __init__(self, activation_mode, n_out=32):
    ...
    def _make_layer(self, block, planes, blocks, stride, pad, dilation, activation_mode):
        downsample = None
