...
#    r = load(fname)
#    cfg.merge(r)
#    # change the name to the last added config
...
#        yaml.dump(cfg.strip(), f, default_flow_style=False)
#
#add_cfg(os.path.join(path, '../experiments', 'defaults.yaml'))
#add_cfg(os.path.join(path, '../experiments', 'settings.yaml'))
#
#def getdir():
#    if 'name' not in cfg:
#        cfg['name'] = 'testing'
#
#    checkpoint_dir = os.path.join(cfg.train_dir, cfg.name)
#    return checkpoint_dir
#
#def makedir():
#    checkpoint_dir = getdir()
